...
export default function RecodringsSwipeImgs({}: Props) {
    return (
        <div className="h-[100vh] overflow-hidden">
            <h1 className="absolute top-[15%] left-1/2 transform -translate-x-1/2 font-bold text-xl text-black z-10">
                Recordings
            </h1>
            <motion.div
                initial={{ opacity: 0 }}
                ...
                className="flex items-center justify-center h-[85vh] sm:h-[95vh] w-full lg:p-52 xl:p-48 border-[10px] border-white bg-gradient-to-tr from-neutral-100 to-gray-200 top-[74px] absolute"
            >
                <Swiper
                    effect={"coverflow"}
                    grabCursor={true}
                ...
                >
                    ...
                    <SwiperSlide>
                        <Link href="https://onyxclassics.com/release/beethoven-sonatina-for-viola-and-cello-duo-for-viola-and-cello-et-al/">
                            <Image
                                src="/recordings/8_beethoven.jpg"
                                alt="rec"
                                width={200}
                                height={200}
                                className="rounded-lg md:w-64"
                    ...
                    <SwiperSlide>
                        <Link href="https://onyxclassics.com/release/kancheli-styx-tavener-the-myrrh-bearer/">
                            <Image
                                src="/recordings/13_kanchelli.jpg"
                                alt="rec"
                                width={200}
                                height={200}
                                className="rounded-lg md:w-64"
