...
export default function Concerts({
  ...
  useEffect(() => {
    ...
    const totalHeight = heights.reduce((acc, height) => acc + height, 0) - 50;
  ...
  return (
    <div>
      <div className="w-full relative text-black min-h-full flex flex-col items-center overflow-hidden">
        <PastConcerts />
