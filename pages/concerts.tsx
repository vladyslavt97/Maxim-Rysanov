  ...
  return (
    <div className=''>
      <div className='bg-gradient-to-tr from-neutral-100 to-gray-200 w-full border-[10px] border-gray-300 absolute top-[70px] rounded text-black min-h-full flex flex-col items-center'>
        <PastConcerts/>
        <div className='absolute left-1 top-[29px] md:static md:flex md:justify-center md:items-center pt-5'>
        ...
        className='flex flex-col ml-16 mr-3 mt-10 justify-center items-start mb-40 lg:text-xl'>
