...
export default function Contacts({}: Props) {
  return (
    <div className='h-[85vh] flex justify-start md:justify-evenly items-center flex-col text-black bg-gradient-to-tr from-neutral-100 to-gray-200 w-full border-[10px] border-gray-300 absolute top-[70px]'>
        ...
        <div className='flex flex-row overflow-x-scroll gap-10 sm:gap-1 justify-start pl-10 pb-5 md:mx-56 md:my-40 overflow-y-hidden scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#303030]/80'>
