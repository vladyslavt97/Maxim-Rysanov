...
export default function Contacts({}: Props) {
  return (
    <div className='h-[85vh] flex justify-start items-center flex-col text-black bg-gradient-to-tr from-neutral-100 to-gray-200 w-full border-[10px] border-gray-300 absolute top-[70px]'>
        <h1 className='font-bold m-5'>Gallery</h1>
        <Link href="https://www.dropbox.com/sh/jcicv8jc17xq1cp/AABx6m5r-R38LxWhj69mtE-ra?dl=0" target="_blank" className='absolute right-0'>
        ...
        <div className='flex flex-row overflow-scroll gap-10 justify-start pl-10 pb-5'>
            <Image src={mr1} alt="photo" width={250} height={250} className='rounded-lg'/>
            <Image src={mr2} alt="photo" width={250} height={250} className='rounded-lg'/>
            <Image src={mr3} alt="photo" width={250} height={250} className='rounded-lg'/>
