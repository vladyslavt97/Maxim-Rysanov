...
export default function Media({}: Props) {
    ...
    return (
        <div>
            <div className="absolute top-[11%] sm:top-[5.5%] border-[10px] border-gray-300 bg-gradient-to-tr from-neutral-100 to-gray-100 w-full h-[220%] md:h-[120%] flex flex-col items-center gap-10">
                ...
                >
                    ...
                    <YouTube opts={opts} videoId="5vcPeS7A-Ds" />
                </motion.div>
            </div>
        </div>
    );
