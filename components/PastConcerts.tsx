    ...
    <div className='rounded--lg fixed right-2'>
      ...
      className='flex flex-col bg-white text-black rounded-lg drop-shadow-md'>
        ...
        <motion.div
          ...
          >
          <Link href="/concerts"><button onClick={e=>setOpen(!open)}>Upcoming 2023</button></Link>
        </motion.div>}
        {router.pathname !== "/concerts-2023" && 
        <motion.div
          initial={{opacity:0}}
        ...
        <motion.div
          ...
          className='hover:bg-slate-300 py-2 hover:rounded-lg border-b-2 border-gray-300 text-sm text-center'
          >
          <Link href="/concerts-2022" ><button onClick={e=>setOpen(!open)}>Concerts 2022</button></Link>
        </motion.div>
        <motion.div
          initial={{opacity:0}}
          animate={{opacity:1}}
          ...
          className='hover:bg-slate-300 py-2 hover:rounded-lg border-b-2 border-gray-300 text-sm text-center'>
        <Link href="/concerts-2021"><button onClick={e=>setOpen(!open)}>Concerts 2021</button></Link>
        </motion.div>
         <motion.div
          initial={{opacity:0}}
          animate={{opacity:1}}
      ...
      animate={{height: 150, opacity: 1}}
      transition={{duration: 1}}
      className='hidden md:flex flex-col bg-white text-black rounded-b-lg mx-3 px-3 drop-shadow-md'>
        {router.pathname === "/concerts-2023" && 
        <motion.div
          initial={{opacity:0}}
          animate={{opacity:1}}
