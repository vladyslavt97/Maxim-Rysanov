...
export default function PastConcerts({
    ...
    return (
        <div className="rounded--lg absolute right-2 z-40">
            <button
                ...
                >
                    {upcomingLabel && !isCurrentPath(upcomingHref) && (
                        <motion.div
                            ...
                            className="hover:bg-slate-300 py-2 hover:rounded-lg border-b-2 border-white text-sm text-center"
                        >
                    ...
                    {archiveLinks.map(({ href, label, delay }, idx) => {
                        ...
                        const isLastVisible =
                            ...
                            archiveLinks
                                .slice(idx + 1)
                                .every((link) => isCurrentPath(link.href));
                        return (
                            <motion.div
                                key={href}
                                initial={{ opacity: 0 }}
