...
export default function HorizontalGallery({}: Props) {
    ...
    return (
        <div className='flex flex-row overflow-x-scroll object-contain gap-1 justify-start pl-1 pb-5 overflow-y-hidden scrollbar scrollbar-track-gray-400 scrollbar-thumb-[#303030] mx-5 md:mx-52 h-[350px] absolute top-1/2 -translate-y-1/2' style={{ overflowY: 'hidden' }}>
