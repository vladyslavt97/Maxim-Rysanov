    ...
    return (
        ...
        >
            <motion.div
                ...
                className="z-10 absolute top-[3%] md:top-[12%] flex justify-start items-start h-[97%] md:h-[60vh] text-gray-800 flex-col text-sm md:text-md md:text-2xl xl:text-3xl xl:font-normal lg:leading-relaxed md:ml-[5%] lg:ml-[12%] overflow-y-scroll w-[50%]"
            >
