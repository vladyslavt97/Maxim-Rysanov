...
export default function HomePage({}: Props) {
  return (
    <div className='absolute top-[70px] bg-white w-[90vw] h-[85vh] m-[2.5vh]'>
        <div className='absolute w-[45%] top-[10%] sm:w-[50%] p-5 flex justify-center items-start h-[70vh] text-gray-800 flex-col text-sm md:text-md z-30 md:text-2xl md:ml-[12%]'>
            <p className='italic'>
