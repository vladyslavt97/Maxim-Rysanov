    ...
    return (
        <header className='fixed w-full top-0 p-1 pr-5 flex flex-row justify-between bg-gradient-to-r from-gray-700 to-gray-900 items-center z-50 h-[82px] border-gray-300 border-b-[10px]'>
            ...
            <motion.div 
                ...
                {/* sidebar with framer */}
            <motion.div className={menu ? 'absolute bg-gradient-to-tr from-gray-200 to-gray-300 h-[100vh] right-[0px] top-0 md:hidden drop-shadow-2xl' : 'absolute bg-gray-600/0 md:hidden'}
                animate={{
                    width: menu ? '50%' : '50%',
                    x: menu ? 0 : 100,
                    opacity: menu ? 1 : 0
